...
public:
	...
	bool insertGroupMember(const int& groupID, const string& userID);	//添加群成员			//new
	...
	bool queryGroupMembers(const int& groupID, vector<pair<string, GroupMemberIdentity>>& result);	//读取群组成员			//new
